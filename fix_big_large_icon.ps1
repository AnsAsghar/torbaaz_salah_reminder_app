# PowerShell script to fix the bigLargeIcon ambiguity issue

$packagePath = "$env:LOCALAPPDATA\Pub\Cache\hosted\pub.dev\flutter_local_notifications-13.0.0\android\src\main\java\com\dexterous\flutterlocalnotifications"
